...
extern void MB_write(far Packet *_packet, 
											unsigned char id, 
											unsigned char function, 
											unsigned int address, 
...
extern void MB_init( unsigned long system_clock,								
											long baud,
											long _timeout, 
											long _polling, 
...
extern MBErrorCode MB_getStatus(void);


/*******************************************************
* Functions outside library file
*******************************************************/
